...
import { useEffect } from 'react'; // will work like componenentDidMount() -- to load content after something loads 
...
function News(props) {
    ...
    useEffect(() => {
        document.title = `${capitalizeFirstLetter(props.category)} - RadarNews`;
        updateNews(); 
